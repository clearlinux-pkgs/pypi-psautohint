...
Source0  : https://files.pythonhosted.org/packages/bc/58/dceb8b9fbbe9b2e17c7cedfdcd17131240e9685c724f5ede3f3f7c3755fd/psautohint-2.3.1.zip
...
%prep
%setup -q -n psautohint-2.3.1
cd %{_builddir}/psautohint-2.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642011480
...
cp %{_builddir}/psautohint-2.3.1/COPYING %{buildroot}/usr/share/package-licenses/pypi-psautohint/8359238144a0969705d737fb5f9b1e6b9cd5f16e
cp %{_builddir}/psautohint-2.3.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-psautohint/2b8b815229aa8a61e483fb4ba0588b8b6c491890
